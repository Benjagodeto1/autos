...
if(isset($_POST['submit'])){
    if(strlen($_POST['marca']) >= 1 && strlen($_POST['modelo']) && strlen($_POST['foto'])>= 1 && strlen($_POST['descripcion'])>= 1){
        ...
        if($result){
            ...
            ?><div class="text-center bg-success">Datos enviados exitosamente </div><?php
        }
            
        }else{
    ?><div class="text-center bg-warning" >Por favor, introduzca una fecha valida </div><?php
}
        }else{
            ?><div class="text-center bg-warning" >Por favor, introduzca una precio valido </div><?php

        }
}else{
    ?><div class="text-center bg-warning">Porfavor complete los campos</div><?php
}
}
?>
...
<div class="container">
    <header class="d-flex flex-wrap  py-3 mb-4 border-bottom">
      <ul class="nav nav-pills">
        <li class="nav-item"><a href="index.php" class="btn boton">Home</a></li>
      </ul>
    </header>
  </div>
<div class="container">
        ...
        <div class="col-md-12">
            <div class="well well-sm">
                <form class="form-horizontal" method="post">
                    <fieldset>
                        <legend class="text-center header bg-light" style="font-size: 1.8rem;">Ingresar vehiculo</legend>
