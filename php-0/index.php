...
<div class="container">
    <header class="d-flex flex-wrap  py-3  border-bottom">
      <ul class="nav nav-pills">
		...
		<form method="post">
		<input type="text" id="buscar" name="buscar" value="" value="<?php
		$a = "aaaa";
...
<div class="well well-sm">
	...
	if(isset($_POST['buscar'])){	
	  ...
	  $buscar = $_POST['buscar'];
	  $sql= "SELECT * FROM `datos` WHERE marca like '%$buscar%' OR modelo like '%$buscar%'OR precio	like '%$buscar%' OR año	like '%$buscar%'  OR descripcion like '%$buscar%' OR fechapublicacion like '%$buscar%'ORDER BY id DESC";
	  $result = db_query($sql);
